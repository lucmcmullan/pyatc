...
EXPAND_ICON_SIZE = (18, 18)
EXPAND_ICON_OFFSET = 25
EXPAND_ICON_PADDING = 5
...
# === Command Parsing ===
CMD_TURN_TOKENS = ("L", "R", "X", "EX")  # Left, Right, Expedite, etc.
CMD_TAKEOFF_PARAMS_REQUIRED = 3          # RWY, SPEED, ALTITUDE
ALTITUDE_STEP_FT = 1000                  # Each digit (e.g. "3") means 3,000 ft
